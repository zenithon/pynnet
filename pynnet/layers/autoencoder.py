...
class ConvAutoencoder(NNet):
    ...
    def build(self, input):
        ...
        >>> theano.pp(cae.cost)
        "((((sum(((tanh((ConvOp{('imshp', None),('kshp', (3, 3)),('nkern', 2),('bsize', None),('dx', 1),('dy', 1),('out_mode', 'valid'),('unroll_batch', 0),('unroll_kern', 0),('unroll_patch', True),('imshp_logical', None),('kshp_logical', (3, 3)),('kshp_logical_top_aligned', True)}(tanh((ConvOp{('imshp', None),('kshp', (3, 3)),('nkern', 2),('bsize', None),('dx', 1),('dy', 1),('out_mode', 'full'),('unroll_batch', 0),('unroll_kern', 0),('unroll_patch', True),('imshp_logical', None),('kshp_logical', (3, 3)),('kshp_logical_top_aligned', True)}(x, filter) + DimShuffle{0, x, x}(b))), filter) + DimShuffle{0, x, x}(b))) - x) ** 2)) / ((tanh((ConvOp{('imshp', None),('kshp', (3, 3)),('nkern', 2),('bsize', None),('dx', 1),('dy', 1),('out_mode', 'valid'),('unroll_batch', 0),('unroll_kern', 0),('unroll_patch', True),('imshp_logical', None),('kshp_logical', (3, 3)),('kshp_logical_top_aligned', True)}(tanh((ConvOp{('imshp', None),('kshp', (3, 3)),('nkern', 2),('bsize', None),('dx', 1),('dy', 1),('out_mode', 'full'),('unroll_batch', 0),('unroll_kern', 0),('unroll_patch', True),('imshp_logical', None),('kshp_logical', (3, 3)),('kshp_logical_top_aligned', True)}(x, filter) + DimShuffle{0, x, x}(b))), filter) + DimShuffle{0, x, x}(b))) - x) ** 2).shape[0]) / ((tanh((ConvOp{('imshp', None),('kshp', (3, 3)),('nkern', 2),('bsize', None),('dx', 1),('dy', 1),('out_mode', 'valid'),('unroll_batch', 0),('unroll_kern', 0),('unroll_patch', True),('imshp_logical', None),('kshp_logical', (3, 3)),('kshp_logical_top_aligned', True)}(tanh((ConvOp{('imshp', None),('kshp', (3, 3)),('nkern', 2),('bsize', None),('dx', 1),('dy', 1),('out_mode', 'full'),('unroll_batch', 0),('unroll_kern', 0),('unroll_patch', True),('imshp_logical', None),('kshp_logical', (3, 3)),('kshp_logical_top_aligned', True)}(x, filter) + DimShuffle{0, x, x}(b))), filter) + DimShuffle{0, x, x}(b))) - x) ** 2).shape[1]) / ((tanh((ConvOp{('imshp', None),('kshp', (3, 3)),('nkern', 2),('bsize', None),('dx', 1),('dy', 1),('out_mode', 'valid'),('unroll_batch', 0),('unroll_kern', 0),('unroll_patch', True),('imshp_logical', None),('kshp_logical', (3, 3)),('kshp_logical_top_aligned', True)}(tanh((ConvOp{('imshp', None),('kshp', (3, 3)),('nkern', 2),('bsize', None),('dx', 1),('dy', 1),('out_mode', 'full'),('unroll_batch', 0),('unroll_kern', 0),('unroll_patch', True),('imshp_logical', None),('kshp_logical', (3, 3)),('kshp_logical_top_aligned', True)}(x, filter) + DimShuffle{0, x, x}(b))), filter) + DimShuffle{0, x, x}(b))) - x) ** 2).shape[2]) / ((tanh((ConvOp{('imshp', None),('kshp', (3, 3)),('nkern', 2),('bsize', None),('dx', 1),('dy', 1),('out_mode', 'valid'),('unroll_batch', 0),('unroll_kern', 0),('unroll_patch', True),('imshp_logical', None),('kshp_logical', (3, 3)),('kshp_logical_top_aligned', True)}(tanh((ConvOp{('imshp', None),('kshp', (3, 3)),('nkern', 2),('bsize', None),('dx', 1),('dy', 1),('out_mode', 'full'),('unroll_batch', 0),('unroll_kern', 0),('unroll_patch', True),('imshp_logical', None),('kshp_logical', (3, 3)),('kshp_logical_top_aligned', True)}(x, filter) + DimShuffle{0, x, x}(b))), filter) + DimShuffle{0, x, x}(b))) - x) ** 2).shape[3])"
        """
        NNet.build(self, input)
